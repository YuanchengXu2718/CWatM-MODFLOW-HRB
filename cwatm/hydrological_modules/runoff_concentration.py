...
# --------------------------------------------------------------------------		
    ...
    def dynamic(self):
        ...
        self.var.dRF0 = self.var.directRunoff[0] * self.var.cellArea / 10
        self.var.itF0 = self.var.interflow[0] * self.var.cellArea / 10
        self.var.aWI0 = self.var.availWaterInfiltration[0] * self.var.cellArea / 10
        self.var.inf0 = self.var.infiltration[0] * self.var.cellArea / 10
        self.var.pref0 = self.var.prefFlow[0] * self.var.cellArea / 10
        self.var.capM3 = self.var.capillar * self.var.cellArea / 10
        # self.var.iF4 = self.var.interflow[4] * self.var.cellArea / 10
        self.var.lsfRF0 = self.var.landSurfaceRunoff[0] * self.var.fracVegCover[0] * self.var.cellArea / 10
        self.var.lsfRF1 = self.var.landSurfaceRunoff[1] * self.var.fracVegCover[1] * self.var.cellArea / 10
        self.var.lsfRF2 = self.var.landSurfaceRunoff[2] * self.var.fracVegCover[2] * self.var.cellArea / 10
        self.var.lsfRF3 = self.var.landSurfaceRunoff[3] * self.var.fracVegCover[3] * self.var.cellArea / 10
        self.var.lsfRF4 = self.var.landSurfaceRunoff[4] * self.var.fracVegCover[4] * self.var.cellArea / 10
        self.var.lsfRF5 = self.var.landSurfaceRunoff[5] * self.var.fracVegCover[5] * self.var.cellArea / 10

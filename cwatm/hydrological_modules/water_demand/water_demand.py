        ...
        * get non-Irrigation water demand and its return flow fraction
        ...
        if checkOption('includeWaterDemand'):
            ...
            if self.var.modflow:
                ...
                # print('\n-------------------------- test point: nonFossilGroundwaterAbs')
                # np.save('./groundwater_storage_available', self.var.groundwater_storage_available)
                # np.save('./pot_GroundwaterAbstract', self.var.pot_GroundwaterAbstract)

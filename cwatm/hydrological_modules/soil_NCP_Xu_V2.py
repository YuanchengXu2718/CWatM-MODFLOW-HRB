...
# Updated in Feb. 2024
# 
# New soil wawter storage and percolation updated on 2025/02/13
# by Yuancheng Xu
# -------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
    ...
    def dynamic(self, coverType, No):
        ...
        # by Yuancheng Xu: seem to be wrong
        # availWaterInfiltration = availWaterInfiltration + self.var.act_irrConsumption[No]
        # if No == 2:
        #     availWaterInfiltration = availWaterInfiltration + \
        #         divideValues(self.var.act_irrPaddyWithdrawal, self.var.fracVegCover[2]) * (1. - self.var.efficiencyPaddy) * self.var.returnfractionIrr
        # elif No == 3:
        #     availWaterInfiltration = availWaterInfiltration + \
        #         divideValues(self.var.act_irrNonpaddyWithdrawal, self.var.fracVegCover[3]) * (1. - self.var.efficiencyNonpaddy) * self.var.returnfractionIrr
        ...
        if self.var.modflow:
            ...
            self.var.capM3_0 = self.var.capillar * self.var.cellArea / 10
        ...
        # if No == 0:
        #     self.var.dRF_0 = self.var.directRunoff[No] * self.var.cellArea / 10
        ...
        # if No == 0:
        #     # print('-------Check', self.var.directRunoff[No].shape, self.var.cellArea.shape)
        #     self.var.dRF_0_m = self.var.directRunoff[No] * self.var.cellArea / 10

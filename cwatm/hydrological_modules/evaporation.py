    ...
    **Functions**
    ...
    def dynamic(self, coverType, No):
        ...
        if dateVar['newStart'] or (dateVar['currDate'].day in [1,11,21]):
            ...
            # print('\n-------------------- No = ', No, 'dateVar[10day] = ', dateVar['10day'], 'filename = ', coverType + '_cropCoefficientNC')
            # print('-------------------- evaporation.py dynamic: shape of cropKC = ', self.var.cropKC.shape)
            # np.save('../../cropKC' + str(No), self.var.cropKC[No])
